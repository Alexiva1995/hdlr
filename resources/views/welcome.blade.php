...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/app-assets/css/pages/coming-soon.css')}}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    ...
    <script src="{{asset('assets/app-assets/vendors/js/coming-soon/jquery.countdown.min.js')}}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('assets/app-assets/js/scripts/pages/coming-soon.js')}}"></script>
    <!-- END: Page JS-->
