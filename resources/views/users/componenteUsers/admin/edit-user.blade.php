                                                    ...
                                                    <div class="form-group">
                                                        <label class="required" for="utc">Zona horaria (Capital del
                                                            ...
                                                            <option value="{{ $user->utc }}">{{ $user->utc }}</option>
                                                                ...
                                                                <option value="Antarctica/Macquarie">(UTC +10:00) Antarctica/Macquarie</option>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            @elseif ( $user->admin == 1 )
                                                            <option class="text-danger text-bold-600" value="{{ $user->admin }}">Administrador</option>
                                                 ...
                                                 <div class="col-4">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <option value="2" @if($user->status == '2') selected  @endif>Suspendido</option>
                                                            <option value="3" @if($user->status == '3') selected  @endif>Bloqueado</option>
                                                            <option value="4" @if($user->status == '4') selected  @endif>Caducado</option>
                                                            <option value="5" @if($user->status == '5') selected  @endif>Eliminado</option>
                                                            </select>
                                                            @error('website')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
